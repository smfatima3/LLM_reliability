...
CONFIG = {
    ...
    'alert_thresholds': { 'r_metric': 0.5 },
    # --- *** FINAL TUNED WEIGHTS *** ---
    # Based on the ablation study, we re-balance the weights to lower the False Positive Rate.
    'r_metric_weights': {
        'w1_lambda': 0.3,   # Proven to be unhelpful, so it's removed.
        'w2_sigma_sq': 0.66, # Given higher importance due to better precision.
        'w3_delta_l': 0.78  # Kept for its high recall, but with reduced influence.
    }
}
